...
#define MASSN_G 939.56536E-03 /*!< \def defines proton mass [MeV] */
#define MASSP_G 938.27231E-03 /*!< \def defines neutron mass [MeV] */
#define MASSn_G (0.5*(MASSN+MASSP)) /*!< \def average nucleon mass [MeV] */
...
#define MASSD_G 1875.6E-03 /*!< \def defines deuteron mass [MeV] */
